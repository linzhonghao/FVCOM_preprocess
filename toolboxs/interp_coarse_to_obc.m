...
% lon = reshape(lon2,1,length(lon1)*length(lat1));lat = reshape(lat2,1,length(lon1)*length(lat1));
...
%-------------------------------------------------------------------
                  case 'no3'
                    ...
                    if min(mask_alt(:)) == 1 && warned(5)
                        warned(5) = false;
                        warning('Removing no3 values below -20 celsius from the coarse data.')
                    end
                    
                  case 'chl'
                    mask_alt = tpctemp2 < -100;
                    if min(mask_alt(:)) == 1 && warned(6)
                        warned(6) = false;
                        warning('Removing chl values below -20 celsius from the coarse data.')
                    end                   
%------------------------------------------------------------------------------
                otherwise
